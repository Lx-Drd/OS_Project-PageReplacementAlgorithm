...
public class DemoUI {
    ...
    public static void main(String[] args) {
        ...
        AlgoPanel     optPanel      = new AlgoPanel(ALGOS[3], cfg, Renderer.GREEN,   "CACHE",       "ACTION");
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "4" -> optPanel.show(sc);
                case "5" -> comparePanel.show(sc);
                case "6" -> workloadPanel.show(sc);
                case "7" -> configPanel.show(sc);
                case "8" -> batchPanel.show(sc);
